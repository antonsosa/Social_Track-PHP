...
<html lang="es">
    <head>
        <meta charset="utf-8">
        <title>Consultar Alumnos - Encargado de Laboratorios</title>
    ...
    <body>
        ...
        <?php $currentPage = 'reporteAlumnosEncargado.php';
        include('includes/navBarEncargado.php'); ?>

        <!-- Header Banner -->
        <?php $bannerTitle = "Consultar Alumnos";
                ...
                <?php
                    ...
                    if(isset($_POST['enviar'])){
                        ...
                        if ($result_horas->num_rows > 0) {
                            ...
                            echo "<div class='row'>";
                            echo "<div class='col-md-12'>";
                            echo "<h3>Información de horas registradas:</h3>";
                            echo "<br>";
