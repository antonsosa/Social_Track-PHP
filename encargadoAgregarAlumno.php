<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $telefono_emergencia = test_input($_POST['emergencia']);
...
<html lang="es">
    <head>
        <meta charset="utf-8">
        <title>Agregar Alumno - Administrador de Laboratorios</title>
    ...
    <body>
        ...
        <?php $currentPage = 'encargadoAgregarAlumno.php';
        ...
        <div class="container" style="width: 800px;">
            <form class="row g-3" id="adminAlumno" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="emergencia" name="emergencia" value="<?php echo isset($telefono_emergencia) ? $telefono_emergencia : ''; ?>" required><br>
                </div>
