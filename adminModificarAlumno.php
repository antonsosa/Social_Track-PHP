...
<html lang="es">
    ...
    <body>
        ...
        <?php $currentPage = 'adminModificarAlumno.php';
        ...
        <div class="container" style="width: 800px;">
            <form class="row g-3" id="adminModificarA" action="adminModificarAlumno.php" method="post">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="carnet" name="carnet" value="<?php echo isset($carnet) ? $carnet : ''; ?>">
                </div>
                <div class="col-md-6">
