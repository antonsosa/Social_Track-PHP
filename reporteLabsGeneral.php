...
<body>
    ...
    <?php $currentPage = 'reporteLabsGeneral.php';
    include('includes/navBarAdmin.php'); ?>

    <!-- Header Banner -->
    <?php $bannerTitle = "Reporte Laboratorios (General)";
    ...
    <div class="container" style="width: 800px;">
        ...
        <div class="container-nav col-md-12">
            ...
            <?php
                ...
                if(isset($_POST['enviar'])){
                    ...
                    if ($result_horas->num_rows > 0) {
                        ...
                        echo "<br>";
                        echo "<br>";
                        echo "<h3 style='text-align: center;'>Resumen de horas registradas para $busqueda en $ciclo</h3>";
                        echo "<br>";
                        ...
                        echo "<th style='width: 5%;'>Total de Horas</th>";
                        echo "</tr>";
                        echo "</thead>";
                        echo "<tbody>";
                        while ($row = $result_horas->fetch_assoc()) {
                            ...
                            echo "<td>" . $row['total_horas_lab'] . "</td>";
                            echo "</tr>";
                        }
                        echo "</tbody>";
                        echo "</table>";
            ...
            <div class="container text-center"><br>
                <a href="pdfLG.php?ciclo=<?php echo urlencode($ciclo); ?>&busqueda=<?php echo urlencode($busqueda); ?>" target="_blank"><img src="./img//PDF64px.png" alt=""></a>
                <a href="excelLG.php?ciclo=<?php echo urlencode($ciclo); ?>&busqueda=<?php echo urlencode($busqueda); ?>" class="icon-link"><img src="./img/excel64px.png" alt=""></a>
            </div><br>
        </form><br>
    </div>
    <style>
