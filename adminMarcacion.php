...
<head>
    <meta charset="utf-8">
    <title>Marcar - Administrador de Laboratorios</title>
...
<body>
    ...
    <?php $currentPage = 'adminMarcacion.php';
    ...
    <div class="container">
        ...
        <div class="form-contenedor">    
            <form class="row g-3" action="adminMarcacion.php" method="post">
                ...
                <div class="contenedor">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <?php
                                // Llamar al procedimiento almacenado para obtener los datos del alumno por carnet
                                $stmt2 = $conexion->prepare("CALL registros_abiertos2");
                                $stmt2->execute();
                                ...
                                if ($result->num_rows > 0) {
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        ?>
                                        <tr>
                                            <form class="form-guardado" action="adminMarcacion.php" method="post" onsubmit="return validarFormulario(<?php echo $row['id_registro_hora']; ?>)">
            ...
            <a href="adminMarcacion.php" > <button type="button" class="btn btn-secondary">Actualizar</button></a>
            </div>
            </form>
        </div>  
