...
<html lang="es">
    ...
    <body>
        ...
        <?php $currentPage = 'encargadoCambioPassword.php';
        include('includes/navBarEncargado.php'); ?>

        <!-- Header Banner -->
        <?php $bannerTitle = "Cambio de Contraseña";
        ...
        <div class="container" style="width: 500px;">
            <form class="row g-3" id="cambioPassword" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                <div class="col-md-12">
                    ...
                    <input type="password" class="form-control" id="contraseña_actual" name="contraseña_actual" required><br>
                </div>
                <div class="col-md-12">
                    <label for="nueva_contraseña" class="form-label">Nueva contraseña</label>
                    <input type="password" class="form-control" id="nueva_contraseña" name="nueva_contraseña" required><br>
                </div>
                <div class="col-md-12">
                    <label for="confirmar_contraseña" class="form-label">Confirmar contraseña</label>
                    <input type="password" class="form-control" id="confirmar_contraseña" name="confirmar_contraseña" required><br>
                </div>
                <div class="container">
                    <div class="row">
                        <!-- Botón "Cancelar" -->
